            ...
            <table class="items-table">
              ...
              <tbody>
                ...
                <tr v-if="filteredRequests.length === 0">
                  <td colspan="5">No claim requests match the selected filters.</td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        requests: [
          { id: 1, itemName: "Watch", requestedBy: "Ali Raza", reason: "Lost similar item last week", location: "Cafeteria", dateRequested: "2024-06-25" },
          { id: 2, itemName: "Bag", requestedBy: "Sara Khan", reason: "Same color and brand", location: "Auditorium", dateRequested: "2024-07-03" },
          { id: 3, itemName: "Umbrella", requestedBy: "Usman Ahmed", reason: "Left during rain", location: "Admin Block", dateRequested: "2024-07-01" },
        ],
        filteredRequests: []
      };
    },
    computed: {
      uniqueLocations() {
        return [...new Set(this.requests.map(req => req.location))];
      }
    },
    mounted() {
